...
const Me = "generated", ht = "touchend", ni = "pointerdown", oi = "pointerup", ct = "pointermove", ri = "touchstart", ai = "touchmove", ut = "pointerleave", li = "pointerout", hi = "touchcancel", ci = "resize", ui = "visibilitychange";
...
class vs {
  ...
  intersectionManager(e) {
    if (!(!P(this) || !this.actualOptions.pauseOnOutsideViewport))
      for (const t of e)
