    ...
    <div class="container p-5 bg-white text-dark rounded-5 mb-5" id="email">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-8 col-xl-6 text-center">
                <h2 class="mt-0">Send me a message and I will reply shortly / Enviame un mensaje y lo responderé a la brevedad</h2>
                <h4 class="mt-0">Write me and we can arrange a meeting / Escribeme y podremos coordinar una reunión.</h4>
            </div>
        </div>
        <div class="row justify-content-center mb-2">
            <div class="col-lg-6">
                <form class="page-section" id="contact contact-form" name="contact" ref="form" @submit.prevent="sendEmail">    
                    ...
                    <!-- Submit Button-->
                    <div class="d-grid"><input class="btn btn-primary btn-xl" id="submitButton" type="submit" value="Send / Enviar"></div>
                </form>
            </div>
        </div>
    </div>    
